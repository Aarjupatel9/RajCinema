...
class UserService {
    ...
    removeVendorDetails(id) {
        return new Promise(function (resolve, reject) {
            ...
            fetch(process.env.REACT_APP_API_SERVER + "/api/vendor/removeVendor", options)
                .then((response) => {
                    console.log("fetch then response :", response);
                    return response.json();
                })
    ...
    updateVendorDetails(data) {
        return new Promise(function (resolve, reject) {
            ...
            fetch(process.env.REACT_APP_API_SERVER + "/api/vendor/updateVendors", options)
                .then((response) => {
                    console.log("fetch then response :", response);
                    return response.json();
                })
    ...
    getVendorDetails(id) {
        return new Promise(function (resolve, reject) {
            ...
            fetch(process.env.REACT_APP_API_SERVER + "/api/vendor/getVendor", options)
                .then((response) => {
                    console.log("fetch then response :", response);
                    return response.json();
                })
    ...
    getAllVendors() {
        return new Promise(function (resolve, reject) {
            ...
            fetch(process.env.REACT_APP_API_SERVER + "/api/vendor/getAllVendors", options)
                .then((response) => {
                    console.log("fetch then response :", response);
                    return response.json();
                })
