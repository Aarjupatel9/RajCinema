...
export default function Stokes() {
    ...
    useEffect(() => {
        const productPromise = canteenService.getAllProducts(id);
    ...
    return (
        <div >
            <nav className="bg-gray-500 border-gray-200 dark:bg-gray-900">
                <div className="flex  bg-gray-300 dark:bg-gray-900 flex-wrap items-center justify-end mx-auto px-3 py-1">
                                    ...
                                    return (
                                        <tr key={product._id} className="border-b border-gray-200 dark:border-gray-600">
                                            ...
                                            <td className="px-6 py-4 dark:text-white dark:bg-gray-700">
                                                {product.productId.salesRate}
                                            </td>

                                            <td className="px-6 py-4 dark:text-white dark:bg-gray-700">
                                                {product.productId.rawItem ? "yes" : "no"}
                                            </td>
