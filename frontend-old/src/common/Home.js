...
import AddVendors from "../adminComponents/AddVendors";
import Vendors from "../adminComponents/Vendors";
import AddCanteen from "../adminComponents/AddCanteen";
import Canteens from "../adminComponents/Canteen";
import CanteenTransfer from "../adminComponents/CanteenTransfer"
import Stokes from "../componentsUser/Stokes";
        ...
        <div className='NotMyNavbar'>
          ...
          <div className="MainComponents ">
            <Routes>
              ...
              <Route path="/stoke/:id" element={<Stokes />} />
          ...
          <div className='NotMyNavbar'>
            ...
            <div className="MainComponents  dark:bg-gray-600">
              <Routes>
                ...
                <Route path="/addVendors/:id" element={<AddVendors />} />
                <Route path="/canteens" element={<Canteens />} />
                <Route path="/addCanteens" element={<AddCanteen />} />
                <Route path="/addCanteens/:id" element={<AddCanteen />} />
                <Route path="/canteenTransfer/:id" element={<CanteenTransfer />} />
                <Route path="/stoke/:id" element={<Stokes />} />
